...
app.get(`/${TODO_SLUG}/:id`, getTodo.bind(null, todo));
app.delete(`/${TODO_SLUG}`, clearTodos.bind(null, todo));
app.post(`/${TODO_SLUG}/:id/done`, markAsDoneTodo.bind(null, todo));
app.delete(`/${TODO_SLUG}/:id/done`, markAsNotDoneTodo.bind(null, todo));
