...
router.get('/', (req, res) => todos.realTodos(req, res));
...
router.delete('/', (req, res) => todos.deleteTodo(req, res));
router.delete('/:id', (req, res) => todos.deleteTodos(req, res));
router.delete('/:id/done', (req, res) => todos.markAsDone(req, res));
