...
The resulting phrase reads as: *Hope* is a slipery slope that leads to a *dissapointing birthday party*.
...
Step 3. write code that randomly picks a`subject` and `puncline` 
